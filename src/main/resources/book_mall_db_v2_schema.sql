...
# Dump of table tb_book_mall_admin_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_admin_user`;

CREATE TABLE `tb_book_mall_admin_user` (
...
LOCK TABLES `tb_book_mall_admin_user` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_admin_user` DISABLE KEYS */;

INSERT INTO `tb_book_mall_admin_user` (`admin_user_id`, `login_user_name`, `login_password`, `nick_name`, `locked`)
VALUES
	(1,'admin','e10adc3949ba59abbe56e057f20f883e','十三',0),
	(2,'newbee-admin1','e10adc3949ba59abbe56e057f20f883e','图书01',0),
	(3,'newbee-admin2','e10adc3949ba59abbe56e057f20f883e','图书02',0);

/*!40000 ALTER TABLE `tb_book_mall_admin_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_book_mall_carousel
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_carousel`;

CREATE TABLE `tb_book_mall_carousel` (
...
LOCK TABLES `tb_book_mall_carousel` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_carousel` DISABLE KEYS */;

INSERT INTO `tb_book_mall_carousel` (`carousel_id`, `carousel_url`, `redirect_url`, `carousel_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_book_mall_carousel` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_book_mall_goods_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_goods_category`;

CREATE TABLE `tb_book_mall_goods_category` (
...
LOCK TABLES `tb_book_mall_goods_category` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_goods_category` DISABLE KEYS */;

INSERT INTO `tb_book_mall_goods_category` (`category_id`, `category_level`, `parent_id`, `category_name`, `category_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_book_mall_goods_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_book_mall_goods_info
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_goods_info`;

CREATE TABLE `tb_book_mall_goods_info` (
...
LOCK TABLES `tb_book_mall_goods_info` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_goods_info` DISABLE KEYS */;

INSERT INTO `tb_book_mall_goods_info` (`goods_id`, `goods_name`, `goods_intro`, `goods_category_id`, `goods_cover_img`, `goods_carousel`, `goods_detail_content`, `original_price`, `selling_price`, `stock_num`, `tag`, `goods_sell_status`, `create_user`, `create_time`, `update_user`, `update_time`)
VALUES
	...
	(10011,'无印良品 MUJI 平衡高保湿化妆水','图书精选',0,'/goods-img/16230038-bf86-4d4e-a11f-954b9ee4bab2.jpg','/goods-img/16230038-bf86-4d4e-a11f-954b9ee4bab2.jpg','商品介绍加载中...',130,65,1000,'',0,0,'2019-09-18 13:18:47',0,'2019-09-18 13:18:47'),
	...
	(10017,'无印良品 MUJI 便携式香薰机','图书精选',0,'/goods-img/a9c0d929-6f0b-4bc7-819c-e5015f447a9e.jpg','/goods-img/a9c0d929-6f0b-4bc7-819c-e5015f447a9e.jpg','商品介绍加载中...',200,200,1000,'',0,0,'2019-09-18 13:18:47',0,'2019-09-18 13:18:47'),
	...
	(10021,'无印良品（MUJI） 无针订书机 其他','图书精选',0,'/goods-img/cf19de8b-e94e-4513-aecd-a0b5c976b738.jpg','/goods-img/cf19de8b-e94e-4513-aecd-a0b5c976b738.jpg','商品介绍加载中...',52,52,1000,'',0,0,'2019-09-18 13:18:47',0,'2019-09-18 13:18:47'),
	...
	(10032,'无印良品 MUJI 平衡高保湿化妆水','图书精选',0,'/goods-img/eb13afc6-8898-4a50-9f93-06dd2593c313.jpg','/goods-img/eb13afc6-8898-4a50-9f93-06dd2593c313.jpg','商品介绍加载中...',130,65,1000,'',0,0,'2019-09-18 13:18:52',0,'2019-09-18 13:18:52'),
	...
	(10038,'无印良品 MUJI 便携式香薰机','图书精选',0,'/goods-img/6ab010e2-5f1e-4512-bd22-4c2550915d4c.jpg','/goods-img/6ab010e2-5f1e-4512-bd22-4c2550915d4c.jpg','商品介绍加载中...',200,200,1000,'',0,0,'2019-09-18 13:18:52',0,'2019-09-18 13:18:52'),
	...
	(10042,'无印良品（MUJI） 无针订书机 其他','图书精选',0,'/goods-img/a7221688-3c37-4ac0-b07e-d8bde1525d1e.jpg','/goods-img/a7221688-3c37-4ac0-b07e-d8bde1525d1e.jpg','商品介绍加载中...',52,52,1000,'',0,0,'2019-09-18 13:18:52',0,'2019-09-18 13:18:52'),
	...
	(10049,'无印良品（MUJI） 钢制指甲刀 小','图书精选',0,'/goods-img/2c150720-4b3a-4d9e-9ce6-77eb4998e1f1.jpg','/goods-img/2c150720-4b3a-4d9e-9ce6-77eb4998e1f1.jpg','商品介绍加载中...',42,42,1000,'',0,0,'2019-09-18 13:19:02',0,'2019-09-18 13:19:02'),
	...
	(10051,'无印良品 MUJI PET喷雾小分装瓶100ml','图书精选',0,'/goods-img/0ec8c4a7-aedc-464d-9e23-d3e4acafdc73.jpg','/goods-img/0ec8c4a7-aedc-464d-9e23-d3e4acafdc73.jpg','商品介绍加载中...',30,30,1000,'',0,0,'2019-09-18 13:19:02',0,'2019-09-18 13:19:02'),
	...
	(10060,'无印良品（MUJI） PET分裝瓶','图书精选',0,'/goods-img/24bf1630-0339-4c22-ad19-37152c561e71.jpg','/goods-img/24bf1630-0339-4c22-ad19-37152c561e71.jpg','商品介绍加载中...',15,15,1000,'',0,0,'2019-09-18 13:19:02',0,'2019-09-18 13:19:02'),
	...
	(10062,'无印良品（MUJI） PE分裝瓶','图书精选',0,'/goods-img/9b3af7c2-57f5-48a7-bea5-603b2d145000.jpg','/goods-img/9b3af7c2-57f5-48a7-bea5-603b2d145000.jpg','商品介绍加载中...',10,10,1000,'',0,0,'2019-09-18 13:19:02',0,'2019-09-18 13:19:02'),
	...
	(10065,'无印良品（MUJI） 聚丙烯化妆盒 半透明约150x220x169mm','图书精选',0,'/goods-img/6dc279ac-fef0-401c-8604-b18dc9a9f7ab.jpg','/goods-img/6dc279ac-fef0-401c-8604-b18dc9a9f7ab.jpg','商品介绍加载中...',40,40,1000,'',0,0,'2019-09-18 13:19:02',0,'2019-09-18 13:19:02'),
	(10066,'无印良品（MUJI） 散粉小 自然色','图书精选',0,'/goods-img/94764fac-f4ad-4ee8-8d26-21af0c09ea76.jpg','/goods-img/94764fac-f4ad-4ee8-8d26-21af0c09ea76.jpg','商品介绍加载中...',60,60,1000,'',0,0,'2019-09-18 13:19:02',0,'2019-09-18 13:19:02'),
	...
	(10071,'无印良品（MUJI） 钢制指甲刀 小','图书精选',0,'/goods-img/f9964432-a9b7-45c2-ac6d-680130c2d7a7.jpg','/goods-img/f9964432-a9b7-45c2-ac6d-680130c2d7a7.jpg','商品介绍加载中...',42,42,1000,'',0,0,'2019-09-18 13:19:07',0,'2019-09-18 13:19:07'),
	...
	(10073,'无印良品 MUJI PET喷雾小分装瓶100ml','图书精选',0,'/goods-img/7f1eec3d-d8e5-4a18-a1a9-b81876dcaaf5.jpg','/goods-img/7f1eec3d-d8e5-4a18-a1a9-b81876dcaaf5.jpg','商品介绍加载中...',30,30,1000,'',0,0,'2019-09-18 13:19:07',0,'2019-09-18 13:19:07'),
	...
	(10082,'无印良品（MUJI） PET分裝瓶','图书精选',0,'/goods-img/e62d04e9-3ae2-431c-8538-becda89e0e84.jpg','/goods-img/e62d04e9-3ae2-431c-8538-becda89e0e84.jpg','商品介绍加载中...',15,15,1000,'',0,0,'2019-09-18 13:19:07',0,'2019-09-18 13:19:07'),
	...
	(10084,'无印良品（MUJI） PE分裝瓶','图书精选',0,'/goods-img/97aa8872-26df-473a-b0d7-f5021776cb52.jpg','/goods-img/97aa8872-26df-473a-b0d7-f5021776cb52.jpg','商品介绍加载中...',10,10,1000,'',0,0,'2019-09-18 13:19:07',0,'2019-09-18 13:19:07'),
	...
	(10087,'无印良品（MUJI） 聚丙烯化妆盒 半透明约150x220x169mm','图书精选',0,'/goods-img/a0a45b44-82c9-4a58-a972-304bed0632bb.jpg','/goods-img/a0a45b44-82c9-4a58-a972-304bed0632bb.jpg','商品介绍加载中...',40,40,1000,'',0,0,'2019-09-18 13:19:07',0,'2019-09-18 13:19:07'),
	(10088,'无印良品（MUJI） 散粉小 自然色','图书精选',0,'/goods-img/a1b8ff33-ec01-494e-a1db-fb5158f3c168.jpg','/goods-img/a1b8ff33-ec01-494e-a1db-fb5158f3c168.jpg','商品介绍加载中...',60,60,1000,'',0,0,'2019-09-18 13:19:07',0,'2019-09-18 13:19:07'),
	...
	(10090,'无印良品（MUJI） PET小分装瓶100ml','图书精选',0,'/goods-img/2ffe59f3-559f-4e6f-810d-1b6fa4ac04e1.jpg','/goods-img/2ffe59f3-559f-4e6f-810d-1b6fa4ac04e1.jpg','商品介绍加载中...',30,30,1000,'',0,0,'2019-09-18 13:19:17',0,'2019-09-18 13:19:17'),
	...
	(10106,'无印良品（MUJI） 自然亲肤粉底液 自然透亮色','图书精选',0,'/goods-img/09576fcd-ea01-4b1d-bed4-be96b71f2c4e.jpg','/goods-img/09576fcd-ea01-4b1d-bed4-be96b71f2c4e.jpg','商品介绍加载中...',75,75,1000,'',0,0,'2019-09-18 13:19:17',0,'2019-09-18 13:19:17'),
	...
	(10108,'无印良品（MUJI） PET小分装瓶100ml','图书精选',0,'/goods-img/755a34a3-bc3e-4f04-8943-f79860012e78.jpg','/goods-img/755a34a3-bc3e-4f04-8943-f79860012e78.jpg','商品介绍加载中...',30,30,1000,'',0,0,'2019-09-18 13:19:22',0,'2019-09-18 13:19:22'),
	...
	(10124,'无印良品（MUJI） 自然亲肤粉底液 自然透亮色','图书精选',0,'/goods-img/7f905827-5765-40bc-a1b8-bedd9f407ced.jpg','/goods-img/7f905827-5765-40bc-a1b8-bedd9f407ced.jpg','商品介绍加载中...',75,75,1000,'',0,0,'2019-09-18 13:19:22',0,'2019-09-18 13:19:22'),
	...
	(10126,'无印良品 MUJI 保湿化妆液','图书精选',0,'/goods-img/53a089a9-e1d1-487e-974e-18bb4df41cf3.jpg','/goods-img/53a089a9-e1d1-487e-974e-18bb4df41cf3.jpg','商品介绍加载中...',160,80,1000,'',0,0,'2019-09-18 13:19:30',0,'2019-09-18 13:19:30'),
	...
	(10131,'无印良品（MUJI） 可携带用小卷尺 白色','图书精选',0,'/goods-img/a4d3a61e-b0d3-4c58-85d6-fddf1de85f66.jpg','/goods-img/a4d3a61e-b0d3-4c58-85d6-fddf1de85f66.jpg','商品介绍加载中...',28,28,1000,'',0,0,'2019-09-18 13:19:30',0,'2019-09-18 13:19:30'),
	...
	(10134,'无印良品（MUJI） 手动碎纸机','图书精选',0,'/goods-img/f6e1ce14-a590-4736-9d36-df5628bc4188.jpg','/goods-img/f6e1ce14-a590-4736-9d36-df5628bc4188.jpg','商品介绍加载中...',75,75,1000,'',0,0,'2019-09-18 13:19:30',0,'2019-09-18 13:19:30'),
	...
	(10138,'无印良品（MUJI） 树脂携带型订书机 白色','图书精选',0,'/goods-img/21dd6bd9-c4bc-4e17-8fed-23775cebf361.jpg','/goods-img/21dd6bd9-c4bc-4e17-8fed-23775cebf361.jpg','商品介绍加载中...',42,42,1000,'',0,0,'2019-09-18 13:19:30',0,'2019-09-18 13:19:30'),
	...
	(10140,'无印良品（MUJI） 控色隔离霜30g 浅蓝色','图书精选',0,'/goods-img/b2969d29-b073-48f3-aa9a-b8aeb08a98d6.jpg','/goods-img/b2969d29-b073-48f3-aa9a-b8aeb08a98d6.jpg','商品介绍加载中...',65,65,1000,'',0,0,'2019-09-18 13:19:30',0,'2019-09-18 13:19:30'),
	...
	(10143,'无印良品 MUJI 保湿化妆液','图书精选',0,'/goods-img/17656dd7-c0fb-431d-810a-5eb29d07c011.jpg','/goods-img/17656dd7-c0fb-431d-810a-5eb29d07c011.jpg','商品介绍加载中...',160,80,1000,'',0,0,'2019-09-18 13:19:35',0,'2019-09-18 13:19:35'),
	...
	(10148,'无印良品（MUJI） 可携带用小卷尺 白色','图书精选',0,'/goods-img/737afa41-1905-4dbc-ab33-95f8489dde5b.jpg','/goods-img/737afa41-1905-4dbc-ab33-95f8489dde5b.jpg','商品介绍加载中...',28,28,1000,'',0,0,'2019-09-18 13:19:35',0,'2019-09-18 13:19:35'),
	...
	(10151,'无印良品（MUJI） 手动碎纸机','图书精选',0,'/goods-img/58d831e4-07f4-44e2-a994-1a7d585452a1.jpg','/goods-img/58d831e4-07f4-44e2-a994-1a7d585452a1.jpg','商品介绍加载中...',75,75,1000,'',0,0,'2019-09-18 13:19:35',0,'2019-09-18 13:19:35'),
	...
	(10155,'无印良品（MUJI） 树脂携带型订书机 白色','图书精选',0,'/goods-img/3b40971a-3f32-45cf-a99a-aada90ee8e33.jpg','/goods-img/3b40971a-3f32-45cf-a99a-aada90ee8e33.jpg','商品介绍加载中...',42,42,1000,'',0,0,'2019-09-18 13:19:35',0,'2019-09-18 13:19:35'),
	...
	(10157,'无印良品（MUJI） 控色隔离霜30g 浅蓝色','图书精选',0,'/goods-img/66311489-b28b-41c3-ac34-540293df6e42.jpg','/goods-img/66311489-b28b-41c3-ac34-540293df6e42.jpg','商品介绍加载中...',65,65,1000,'',0,0,'2019-09-18 13:19:35',0,'2019-09-18 13:19:35'),
	...
	(10161,'荣耀原装三键线控带麦半入耳式耳机AM116(尊爵版)适用于华为荣耀手机','图书精选',0,'/goods-img/183481c3-47ff-4b2e-926f-b02b926ac02c.jpg','/goods-img/183481c3-47ff-4b2e-926f-b02b926ac02c.jpg','商品介绍加载中...',69,49,998,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	(10162,'诺基亚（NOKIA）BH-705 银白色 5.0真无线蓝牙耳机迷你运动跑步音乐商务入耳式安卓苹果手机蓝牙耳机','图书精选',0,'/goods-img/5e0d089b-fa91-410d-8ff2-9534eb6f627f.jpg','/goods-img/5e0d089b-fa91-410d-8ff2-9534eb6f627f.jpg','详情加载中...',499,499,1000,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	(10163,'华为耳机原装半入耳式有线mate9p10plus8x荣耀v20v10nova2s9iv9p9play 【标准版】华为AM115 白色-热卖款','图书精选',0,'/goods-img/79e2b467-a075-46ef-ab43-aa0535f8e4c9.jpg','/goods-img/79e2b467-a075-46ef-ab43-aa0535f8e4c9.jpg','商品介绍加载中...',69,39,1000,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	...
	(10166,'【自营仓次日达】moloke真无线蓝牙耳机双耳适用于苹果华为小米 运动跑步入耳式oppo迷你商务耳机 【1:1尊享版】自动弹窗+无线充电+可触控（热卖）','图书精选',51,'/goods-img/70dc1586-13bd-4b4c-92a9-fe20aa1d531f.jpg','/goods-img/70dc1586-13bd-4b4c-92a9-fe20aa1d531f.jpg','商品介绍加载中...',359,199,1000,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	...
	(10168,'纽曼（Newmine）NM-LK06 全兼容线控音乐手机耳机 白色','图书精选',0,'/goods-img/ad53ea23-6974-4e44-b62d-eab498ce1d63.jpg','/goods-img/ad53ea23-6974-4e44-b62d-eab498ce1d63.jpg','商品介绍加载中...',9,9,1000,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	(10169,'索尼（SONY）重低音立体声耳机MDR-XB55AP 黑色','图书精选',0,'/goods-img/01e1998d-f183-4e99-b8ba-7715727cf90b.jpg','/goods-img/01e1998d-f183-4e99-b8ba-7715727cf90b.jpg','*黑色实物偏灰，请以实物为准 Bass Booster低音增强器技术可呈现紧实深邃低频。 12 毫米驱动单元和110dB/mW 的高灵敏度，呈现高质感音效。 人体工学设计的倾斜入耳方式，让耳塞能够深入耳朵内部，呈现出色的隔音效果，同时带来舒适的佩戴感和高音质的享受。 耳塞能够深入耳朵内部，呈现出色的隔音效果，同时为您带来舒适的佩戴感和高音质的享受。 采用混合两种硬度硅胶的耳塞套： 核心部分使用硬质材料保持音质，减少因耳塞变形导致的声音失真； 外围部分柔软材料提高了耳塞密闭性，让您能长时间舒适佩戴。 *线控的可用性及操作因智能手机而异 耳机线表面细小沟壑，减少容易引起缠绕的摩擦，使导线不容易纠结在一起，方便欣赏音乐和携带。 防缠绕耳机线 盲点设计 便携袋 防尘滤网 导线滑块 4种尺寸耳塞套 摘下耳机的耳塞套，可见保护单元的网罩，用来防止异物和灰尘堵塞单元，使耳机经久耐听。 在左耳外壳和耳机线的连接处设有浮点，凭手指触摸就能判别左右耳，方便操作。 随机附赠收纳袋一只，保护你心爱的耳机。 利用导线滑块来调整左右耳机线的长度，也能够减少收纳耳机时容易出现的缠线现象 提供4对不同尺寸（SS、S、M、L）的耳塞套（M号出厂时已安装至耳机上），根据你的耳洞大小自由更换，获得良好的隔音效果，佩戴舒适。 ● 立体声耳机 ● 混合硅胶耳塞（SS/S/M/L 每种尺寸2个) *M号出厂时安装至本耳机。 ● 便携袋(×1) *EXTRA BASS 和 EXTRABASS 是索尼公司的商标',229,185,1000,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	...
	(10178,'华为原装降噪有线手机耳机Mate9 10P9P10Plus荣耀V9V10PlayNova2s9i8x 【送耳机收纳包】AM115半入耳式耳机-经典热卖款','图书精选',0,'/goods-img/d6565a7e-473b-4933-93c5-e646495c8c4c.jpg','/goods-img/d6565a7e-473b-4933-93c5-e646495c8c4c.jpg','详情加载中...',99,39,1000,'',0,0,'2019-09-18 13:21:28',0,'2019-09-18 13:21:28'),
	...
	(10182,'荣耀原装三键线控带麦半入耳式耳机AM116(尊爵版)适用于华为荣耀手机','图书精选',0,'/goods-img/6113a562-f3f1-408c-9b0d-78a84407caf7.jpg','/goods-img/6113a562-f3f1-408c-9b0d-78a84407caf7.jpg','商品介绍加载中...',69,49,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	(10183,'诺基亚（NOKIA）BH-705 银白色 5.0真无线蓝牙耳机迷你运动跑步音乐商务入耳式安卓苹果手机蓝牙耳机','图书精选',0,'/goods-img/abb13d3a-3445-4b26-b8e9-44cbec227b5d.jpg','/goods-img/abb13d3a-3445-4b26-b8e9-44cbec227b5d.jpg','详情加载中...',499,499,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	(10184,'华为耳机原装半入耳式有线mate9p10plus8x荣耀v20v10nova2s9iv9p9play 【标准版】华为AM115 白色-热卖款','图书精选',0,'/goods-img/fac9c3e9-4843-46d1-8668-7e2eac17ccf2.jpg','/goods-img/fac9c3e9-4843-46d1-8668-7e2eac17ccf2.jpg','商品介绍加载中...',69,39,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	...
	(10187,'【自营仓次日达】moloke真无线蓝牙耳机双耳适用于苹果华为小米 运动跑步入耳式oppo迷你商务耳机 【1:1尊享版】自动弹窗+无线充电+可触控（热卖）','图书精选',51,'/goods-img/1e5645d1-24cb-48eb-9aaa-f729fa0db195.jpg','/goods-img/1e5645d1-24cb-48eb-9aaa-f729fa0db195.jpg','商品介绍加载中...',359,199,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	...
	(10189,'纽曼（Newmine）NM-LK06 全兼容线控音乐手机耳机 白色','图书精选',0,'/goods-img/0b02244f-6908-4ccb-a9d2-ccb5a462e30e.jpg','/goods-img/0b02244f-6908-4ccb-a9d2-ccb5a462e30e.jpg','商品介绍加载中...',9,9,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	(10190,'索尼（SONY）重低音立体声耳机MDR-XB55AP 黑色','图书精选',0,'/goods-img/eec7b009-a9ff-45cd-a7be-4051eb7b3c22.jpg','/goods-img/eec7b009-a9ff-45cd-a7be-4051eb7b3c22.jpg','*黑色实物偏灰，请以实物为准 Bass Booster低音增强器技术可呈现紧实深邃低频。 12 毫米驱动单元和110dB/mW 的高灵敏度，呈现高质感音效。 人体工学设计的倾斜入耳方式，让耳塞能够深入耳朵内部，呈现出色的隔音效果，同时带来舒适的佩戴感和高音质的享受。 耳塞能够深入耳朵内部，呈现出色的隔音效果，同时为您带来舒适的佩戴感和高音质的享受。 采用混合两种硬度硅胶的耳塞套： 核心部分使用硬质材料保持音质，减少因耳塞变形导致的声音失真； 外围部分柔软材料提高了耳塞密闭性，让您能长时间舒适佩戴。 *线控的可用性及操作因智能手机而异 耳机线表面细小沟壑，减少容易引起缠绕的摩擦，使导线不容易纠结在一起，方便欣赏音乐和携带。 防缠绕耳机线 盲点设计 便携袋 防尘滤网 导线滑块 4种尺寸耳塞套 摘下耳机的耳塞套，可见保护单元的网罩，用来防止异物和灰尘堵塞单元，使耳机经久耐听。 在左耳外壳和耳机线的连接处设有浮点，凭手指触摸就能判别左右耳，方便操作。 随机附赠收纳袋一只，保护你心爱的耳机。 利用导线滑块来调整左右耳机线的长度，也能够减少收纳耳机时容易出现的缠线现象 提供4对不同尺寸（SS、S、M、L）的耳塞套（M号出厂时已安装至耳机上），根据你的耳洞大小自由更换，获得良好的隔音效果，佩戴舒适。 ● 立体声耳机 ● 混合硅胶耳塞（SS/S/M/L 每种尺寸2个) *M号出厂时安装至本耳机。 ● 便携袋(×1) *EXTRA BASS 和 EXTRABASS 是索尼公司的商标',229,185,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	...
	(10199,'华为原装降噪有线手机耳机Mate9 10P9P10Plus荣耀V9V10PlayNova2s9i8x 【送耳机收纳包】AM115半入耳式耳机-经典热卖款','图书精选',0,'/goods-img/0cff5ace-7ab9-43a7-91fe-fb3550829577.jpg','/goods-img/0cff5ace-7ab9-43a7-91fe-fb3550829577.jpg','详情加载中...',99,39,1000,'',0,0,'2019-09-18 13:21:35',0,'2019-09-18 13:21:35'),
	...
	(10205,'【联名限量版】MANSLY口红套装中国风口红情人节女朋友生日礼物唇釉彩妆女磁扣锦绣红妆口红礼盒彩妆 锦绣红妆口红礼盒（6支）','图书精选',86,'/goods-img/c081314e-8f67-44f9-a27e-aad6c3f29343.jpg','/goods-img/c081314e-8f67-44f9-a27e-aad6c3f29343.jpg','商品介绍加载中...',295,295,995,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	(10206,'迪奥（Dior）滋润999礼盒套装（烈艳蓝金999#3.5g 经典正红色+香氛小样1ml*3+礼盒）（小样和礼盒款式随机）','图书精选',0,'/goods-img/39c69481-6d13-4d84-bc1e-7dca612667f0.jpg','/goods-img/39c69481-6d13-4d84-bc1e-7dca612667f0.jpg','商品介绍加载中...',379,379,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	(10207,'圣罗兰（YSL）莹亮纯魅唇膏12#（圆管口红）4.5g 斩男色','图书精选',86,'/goods-img/b4335e82-c9e1-4264-92e4-e324a601fedb.jpg','/goods-img/b4335e82-c9e1-4264-92e4-e324a601fedb.jpg','详情加载中...',320,320,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	(10208,'圣罗兰（YSL）纯口红1#（正红色）3.8g','图书精选',86,'/goods-img/57d0bf26-0a0c-4027-8a2b-deeaa29905ee.jpg','/goods-img/57d0bf26-0a0c-4027-8a2b-deeaa29905ee.jpg','详情加载中...',350,320,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	...
	(10210,'【联名款】MANSLY口红套装红鸾心动口红礼盒中国风开运红情人节女朋友生日礼物唇釉颐和园同款彩妆口红 红鸾心动口红礼盒（6支）','图书精选',86,'/goods-img/f128ad98-fe4d-4264-96e3-6393b6cc98f1.jpg','/goods-img/f128ad98-fe4d-4264-96e3-6393b6cc98f1.jpg','商品介绍加载中...',195,195,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	...
	(10212,'圣罗兰（YSL）纯口红13#（正橘色）3.8g','图书精选',86,'/goods-img/53a4a428-8ca2-4d19-937d-15d18f324237.jpg','/goods-img/53a4a428-8ca2-4d19-937d-15d18f324237.jpg','详情加载中...',320,320,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	...
	(10215,'迪奥（Dior）口红礼盒套装（烈艳蓝金唇膏哑光#999 3.5g正红色+香氛小样1ml*3随机+随机礼盒样式）','图书精选',86,'/goods-img/ab1a0ced-954c-4857-92f4-f7c833d9d54a.jpg','/goods-img/ab1a0ced-954c-4857-92f4-f7c833d9d54a.jpg','商品介绍加载中...',379,379,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	(10216,'圣罗兰（YSL）纯口红52# 3.8g','图书精选',86,'/goods-img/1eefadae-5f62-4abd-b283-077e7b6d9193.jpg','/goods-img/1eefadae-5f62-4abd-b283-077e7b6d9193.jpg','详情加载中...',340,320,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	...
	(10223,'美宝莲（MAYBELLINE）绝色持久唇膏雾感哑光系列R09PM 3.9g（女皇色口红新老包装）','图书精选',86,'/goods-img/1055e30e-3d98-4dca-8b79-8d0b5a09a37b.jpg','/goods-img/1055e30e-3d98-4dca-8b79-8d0b5a09a37b.jpg','商品介绍加载中...',122,106,1000,'',0,0,'2019-09-18 13:24:47',0,'2019-09-18 13:24:47'),
	...
	(10229,'【联名限量版】MANSLY口红套装中国风口红情人节女朋友生日礼物唇釉彩妆女磁扣锦绣红妆口红礼盒彩妆 锦绣红妆口红礼盒（6支）','图书精选',86,'/goods-img/d82ba7f0-6c92-4254-bfb2-71b3f8b1dfda.jpg','/goods-img/d82ba7f0-6c92-4254-bfb2-71b3f8b1dfda.jpg','商品介绍加载中...',295,295,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	(10230,'迪奥（Dior）滋润999礼盒套装（烈艳蓝金999#3.5g 经典正红色+香氛小样1ml*3+礼盒）（小样和礼盒款式随机）','图书精选',0,'/goods-img/f6b1195a-3231-4e81-a676-866ee838748f.jpg','/goods-img/f6b1195a-3231-4e81-a676-866ee838748f.jpg','商品介绍加载中...',379,379,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	(10231,'圣罗兰（YSL）莹亮纯魅唇膏12#（圆管口红）4.5g 斩男色','图书精选',86,'/goods-img/359bb052-5fea-4390-bbe6-4cb9e1c19273.jpg','/goods-img/359bb052-5fea-4390-bbe6-4cb9e1c19273.jpg','详情加载中...',320,320,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	(10232,'圣罗兰（YSL）纯口红1#（正红色）3.8g','图书精选',86,'/goods-img/a42498e5-d912-447b-9360-0659d2d55c42.jpg','/goods-img/a42498e5-d912-447b-9360-0659d2d55c42.jpg','详情加载中...',350,320,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	...
	(10234,'【联名款】MANSLY口红套装红鸾心动口红礼盒中国风开运红情人节女朋友生日礼物唇釉颐和园同款彩妆口红 红鸾心动口红礼盒（6支）','图书精选',86,'/goods-img/a9cd71ad-2db0-4876-9ead-c51233040220.jpg','/goods-img/a9cd71ad-2db0-4876-9ead-c51233040220.jpg','商品介绍加载中...',195,195,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	...
	(10236,'圣罗兰（YSL）纯口红13#（正橘色）3.8g','图书精选',86,'/goods-img/b0142d40-6adb-4d64-b5b2-6e4a34656990.jpg','/goods-img/b0142d40-6adb-4d64-b5b2-6e4a34656990.jpg','详情加载中...',320,320,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	...
	(10239,'迪奥（Dior）口红礼盒套装（烈艳蓝金唇膏哑光#999 3.5g正红色+香氛小样1ml*3随机+随机礼盒样式）','图书精选',86,'/goods-img/cbce65ee-28b3-4822-895a-38243ee506e7.jpg','/goods-img/cbce65ee-28b3-4822-895a-38243ee506e7.jpg','商品介绍加载中...',379,379,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	(10240,'圣罗兰（YSL）纯口红52# 3.8g','图书精选',86,'/goods-img/abff57bf-247b-4881-9589-e1336049c3ba.jpg','/goods-img/abff57bf-247b-4881-9589-e1336049c3ba.jpg','详情加载中...',340,320,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	...
	(10245,'欧莱雅（LOREAL）纷泽滋润唇膏RC301复古魅红3.7g（金管 口红女 滋润显色）','图书精选',86,'/goods-img/3b420562-b449-448d-ae50-e20aab136e1b.jpg','/goods-img/3b420562-b449-448d-ae50-e20aab136e1b.jpg','品牌介绍Brand Description         巴黎欧莱雅通过将科技和美丽的结合，不断谋求创新、研发新的产品配方，以合理的价格，为消费者提供品质的产品和服务。自1907年安全合成染发剂的诞生，如今巴黎欧莱雅的产品已从染发剂扩展到了护肤、彩妆等诸多领域，在中国，巴黎欧莱雅的五大产品线为护肤系列、彩妆系列、家用染发系列、洗护发系列及男士护肤系列。为了将美的产品融于美的文化、艺术、理念，将“从指尖到发梢”的美丽带给全世界的人们，巴黎欧莱雅在全世界范围精心选择各行业明星，组成“梦之队”来见证巴黎欧莱雅的实力，从各个不同的角度来讲述巴黎欧莱雅美丽无疆界的气势，并使“巴黎欧莱雅，你值得拥有！”“Because you are worth it！”的美丽概念成为一种文化！',135,99,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	...
	(10247,'美宝莲（MAYBELLINE）绝色持久唇膏雾感哑光系列R09PM 3.9g（女皇色口红新老包装）','图书精选',86,'/goods-img/63d0a187-627d-4edb-870e-717969ad2bd0.jpg','/goods-img/63d0a187-627d-4edb-870e-717969ad2bd0.jpg','商品介绍加载中...',122,106,1000,'',0,0,'2019-09-18 13:25:08',0,'2019-09-18 13:25:08'),
	...
	(10702,'华为 HUAWEI P30 超感光徕卡三摄麒麟980AI智能芯片全面屏屏内指纹版手机8GB+128GB天空之境全网通双4G手机','图书精选',46,'/goods-img/edb7e8ef-7785-418b-a75e-dfed2aa74e39.jpg','/goods-img/edb7e8ef-7785-418b-a75e-dfed2aa74e39.jpg','详情加载中...',4288,3988,1000,'',0,0,'2019-09-18 13:37:44',0,'2019-09-18 13:37:44'),
	(10703,'华为 HUAWEI P30 超感光徕卡三摄麒麟980AI智能芯片全面屏屏内指纹版手机8GB+128GB亮黑色全网通双4G手机','图书精选',46,'/goods-img/e13294f7-9ab0-42dc-afb1-9f41c59436cf.jpg','/goods-img/e13294f7-9ab0-42dc-afb1-9f41c59436cf.jpg','商品介绍加载中...',4288,3988,1000,'',0,0,'2019-09-18 13:37:44',0,'2019-09-18 13:37:44'),
	(10704,'华为 HUAWEI P30 超感光徕卡三摄麒麟980AI智能芯片全面屏屏内指纹版手机8GB+128GB珠光贝母全网通双4G手机','图书精选',46,'/goods-img/b9e6d770-06dd-40f4-9ae5-31103cec6e5f.jpg','/goods-img/b9e6d770-06dd-40f4-9ae5-31103cec6e5f.jpg','详情加载中...',4288,3988,999,'',0,0,'2019-09-18 13:37:44',0,'2019-09-18 13:37:44'),
	(10705,'华为 HUAWEI P30 超感光徕卡三摄麒麟980AI智能芯片全面屏屏内指纹版手机8GB+128GB极光色全网通双4G手机','图书精选',46,'/goods-img/20312f4e-da4f-49b9-8150-ab54f0302915.jpg','/goods-img/20312f4e-da4f-49b9-8150-ab54f0302915.jpg','商品介绍加载中...',4288,3988,997,'',0,0,'2019-09-18 13:37:44',0,'2019-09-18 13:37:44'),
	(10706,'华为 HUAWEI P30 超感光徕卡三摄麒麟980AI智能芯片全面屏屏内指纹版手机8GB+128GB赤茶橘全网通双4G手机','图书精选',46,'/goods-img/192b1727-bcab-4bdf-8494-182f8ec5b2e6.jpg','/goods-img/192b1727-bcab-4bdf-8494-182f8ec5b2e6.jpg','商品介绍加载中...',4288,3988,993,'',0,0,'2019-09-18 13:37:44',0,'2019-09-18 13:37:44'),
	...
	(10797,'小米9 Pro 5G 全面屏游戏拍照新品手机','图书精选',51,'/goods-img/d5fc8bec-0add-48d3-b73b-349a0375e8dc.jpg','/goods-img/d5fc8bec-0add-48d3-b73b-349a0375e8dc.jpg','详情加载中...',9999,9999,1000,'',0,0,'2019-09-18 13:38:32',0,'2019-09-18 13:38:32'),
...
/*!40000 ALTER TABLE `tb_book_mall_goods_info` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_book_mall_index_config
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_index_config`;

CREATE TABLE `tb_book_mall_index_config` (
...
LOCK TABLES `tb_book_mall_index_config` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_index_config` DISABLE KEYS */;

INSERT INTO `tb_book_mall_index_config` (`config_id`, `config_name`, `config_type`, `goods_id`, `redirect_url`, `config_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_book_mall_index_config` ENABLE KEYS */;
UNLOCK TABLES;

# Dump of table tb_book_mall_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_order`;

CREATE TABLE `tb_book_mall_order` (
...
# Dump of table tb_book_mall_order_address
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_order_address`;

CREATE TABLE `tb_book_mall_order_address` (
...
# Dump of table tb_book_mall_order_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_order_item`;

CREATE TABLE `tb_book_mall_order_item` (
...
# Dump of table tb_book_mall_shopping_cart_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_shopping_cart_item`;

CREATE TABLE `tb_book_mall_shopping_cart_item` (
...
# Dump of table tb_book_mall_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_user`;

CREATE TABLE `tb_book_mall_user` (
...
LOCK TABLES `tb_book_mall_user` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_user` DISABLE KEYS */;

INSERT INTO `tb_book_mall_user` (`user_id`, `nick_name`, `login_name`, `password_md5`, `introduce_sign`, `is_deleted`, `locked_flag`, `create_time`)
VALUES
...
/*!40000 ALTER TABLE `tb_book_mall_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_book_mall_user_address
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_user_address`;

CREATE TABLE `tb_book_mall_user_address` (
...
# Dump of table tb_book_mall_user_token
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_user_token`;

CREATE TABLE `tb_book_mall_user_token` (
  `user_id` bigint(20) NOT NULL COMMENT '用户主键id',
...
DROP TABLE IF EXISTS `tb_book_mall_admin_user_token`;

CREATE TABLE `tb_book_mall_admin_user_token` (
...
# Dump of table tb_book_mall_favor
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_book_mall_favor`;

CREATE TABLE `tb_book_mall_favor` (
                                      `favor_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '收藏主键id',
                                      `user_id` bigint(20) NOT NULL COMMENT '用户主键id',
                                      `goods_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '关联商品id',
                                      `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                      `create_user` int(11) NOT NULL DEFAULT '0' COMMENT '创建者id',
...
LOCK TABLES `tb_book_mall_favor` WRITE;
/*!40000 ALTER TABLE `tb_book_mall_favor` DISABLE KEYS */;

INSERT INTO `tb_book_mall_favor` (`favor_id`, `user_id`, `goods_id`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
    (1,'1',10904,'2019-08-23 17:50:45',0,'2019-11-10 00:23:01',0),
    (2,'1',10901,'2019-11-29 00:00:00',0,'2019-11-29 00:00:00',0),
    (3,'1',10902,'2019-09-19 23:37:40',0,'2019-11-07 00:15:52',0),
    (4,'1',10903,'2019-09-19 23:37:58',0,'2019-10-22 00:15:01',0);

/*!40000 ALTER TABLE `tb_book_mall_favor` ENABLE KEYS */;
UNLOCK TABLES;


 create or replace view tv_book_mall_favors as   SELECT     favor_id, user_id, `tb_book_mall_favor`.goods_id,selling_price, `tb_book_mall_goods_info`.goods_name,goods_intro,goods_category_id,goods_cover_img,`tb_book_mall_favor`.create_time,
    `tb_book_mall_favor`.create_user, `tb_book_mall_favor`.update_time, `tb_book_mall_favor`.update_user from `tb_book_mall_favor` inner join `tb_book_mall_goods_info` where `tb_book_mall_favor`.goods_id=`tb_book_mall_goods_info`.goods_id
